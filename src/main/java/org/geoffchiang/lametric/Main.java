...
import org.geoffchiang.lametric.model.SparklineFrame;
...
public class Main {
    ...
    private static final String APP_ID = "insert your device id - should be start with com.lametric.";
    ...
    public static void main(String[] args) {
        ...
        frames.add(new SparklineFrame(2, Arrays.asList(50, 300, 200, 25, 175, 75, 325, 125)));

        try {
            new PushToLaMetric(APP_ID, ACCESS_TOKEN).push(frames);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
